                    ...
                    <tr class="border-b odd:bg-gray-100 even:bg-gray-50 hover:bg-blue-200 text-xs leading-none">
                        ...
                        <td class="px-2 py-2 border text-xs font-bold">
                            <div class="flex items-center space-x-2 justify-center">
                                ...
                                <button type="button" onclick="onclick="abrirModalMovimientoLibre('{{ $producto->codigo }}')" wire:navigate" class="w-6 h-6 bg-green-100 text-green-600 rounded hover:bg-green-200 flex items-center justify-center" title="Mover producto">
                                ...
                                <x-tabla.boton-eliminar :action=":action="route('productos.destroy', $producto->id)" wire:navigate" />
                            </div>
                        </td>
                    </tr>
                @empty
