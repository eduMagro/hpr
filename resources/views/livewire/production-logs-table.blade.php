<div wire:poll.5s id="production-logs-component">
    <div class="w-full">
                    ...
                    <x-tabla.filtro-row>
                        <th class="p-2">
                            <input type="text" wire:model.live.debounce.300ms="fecha"
                                class="w-full text-xs border border-gray-300 rounded px-2 py-2 text-blue-900 bg-white focus:border-blue-900 focus:ring-1 focus:ring-blue-900 focus:outline-none"
                                placeholder="Fecha...">
                        </th>
                        <th class="p-2">
                    ...
                    @forelse ($logs as $log)
                        ...
                        <tr class="border-b odd:bg-gray-100 even:bg-gray-50 hover:bg-blue-200 text-xs leading-tight transition-colors {{ $isNew ? 'new-log-row bg-green-300 animate-pulse' : '' }}"
                            ...
                            <td class="px-0.5 py-1 text-center border">
                                <span class="px-2 py-2 rounded text-xs font-medium {{ $actionClass }}">
                            ...
                            <td class="px-0.5 py-1 text-center border">
                                @if (isset($log['Observaciones']) && $log['Observaciones'] !== '-' && !empty(trim($log['Observaciones'])))
                                    <button
                                        ...
                                        class="px-2 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700 inline-flex items-center"
                            ...
                            <td class="px-0.5 py-1 text-center border">
                                @if (isset($log['Etiqueta']) && $log['Etiqueta'] !== '-')
                                    <button onclick="filtrarPorEtiqueta('{{ $log['Etiqueta'] }}')"
                                        class="px-2 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 inline-flex items-center"
        ...
        <x-tabla.paginacion-livewire :paginador="$logs" />
    </div>
</div>
