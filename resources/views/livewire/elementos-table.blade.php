                    ...
                    <x-tabla.header>
                        ...
                        <x-tabla.filtro-row>
                            ...
                            <th class="p-2 bg-white text-left align-middle">
                                <div class="flex justify-start gap-2 items-center h-full">
                                    {{-- ♻️ Botón reset --}}
                                    <button wire:click="limpiarFiltros"
                                        class="bg-gray-700 hover:bg-gray-600 text-white px-3 py-2 rounded text-xs flex items-center justify-center shadow-sm"
                            ...
                            <tr tabindex="0" wire:key="elemento-{{ $elemento->id }}" x-data="{
                                ...
                                <td class="px-1 py-3 text-center border">
                                    <div class="flex items-center justify-center gap-1">
                                        ...
                                        <div class="w-8 h-8 bg-gray-200 text-gray-700 rounded hover:bg-gray-300 flex items-center justify-center abrir-modal-dibujo flex-shrink-0 cursor-pointer transition"
