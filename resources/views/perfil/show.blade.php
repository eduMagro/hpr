<x-app-layout>
    ...
    {{-- $contratosIncorporacion y $hasIncorporacion vienen del controlador (optimizado) --}}
    ...
    {{-- FullCalendar - OPTIMIZADO: solo locale español en vez de todos --}}
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/fullcalendar@6.1.8/index.global.min.css">
    {{-- CSS del calendario separado para mejor cacheo --}}
    ...
    {{-- Estilos del calendario movidos a public/css/calendario-perfil.css para mejor cacheo --}}
