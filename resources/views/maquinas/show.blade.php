            ...
            <div class="bg-white border p-4 shadow-md rounded-lg self-start sm:col-span-2 md:sticky md:top-4">
                <div class="flex flex-col gap-4">
                    ...
                    <div class="bg-gray-100 border p-2 shadow-md rounded-lg">
                       ...
                       <div class="mb-4">
    <label for="itemType" class="block text-gray-700 font-semibold">Selecciona el tipo:</label>
...
<div class="mb-4">
    ...
    <input type="text" id="qrItem" class="border rounded p-2 w-full" placeholder="Escanea o ingresa un código QR">
</div>
