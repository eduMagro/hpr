<x-app-layout>
    ...
    <x-page-header title="Máquinas" subtitle="Gestión y monitoreo de maquinaria de producción"
    ...
    <div class="p-4 sm:p-6 lg:p-10 min-h-screen">
        ...
        <div class="mb-6 flex flex-col xl:flex-row gap-4 items-start xl:items-center justify-between">
            ...
            <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                ...
                <x-tabla.boton-azul :href="route('maquinas.create')" class="whitespace-nowrap flex items-center gap-2">
