<x-app-layout>
    ...
    <x-page-header
        ...
        subtitle="Gestión de EPIs y tallas del personal"
        icon='<svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>'
    />

    <div class="py-6 px-4 min-h-screen" x-data="episPage()" x-init="init()">
        <div class="max-w-6xl mx-auto space-y-6">
                ...
                <div
                    ...
                    <button @click="activeView = 'tallas'" :class="activeView === 'tallas' ? 'bg-white text-blue-700 shadow-md ring-1 ring-black/5' :
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            ...
                            class="lucide lucide-shirt-icon lucide-shirt h-5 w-5">
                            <path
            ...
            <div x-show="activeView === 'agenda'" x-transition:enter="transition ease-out duration-300"
                ...
                <div
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            <label class="block text-xs font-medium text-gray-700 mb-1">Filtrar usuarios por
                                EPI</label>
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center sm:gap-3">
                                ...
                                <template x-if="modalTab === 'usuario' && selectedUser">
                                    <div
                                        ...
                                        <span
                                            x-text="`Empresa: ${selectedUser.empresa?.nombre || 'Sin empresa'}`"></span>
                                    </div>
                                </template>
                            </div>
                        </div>

                        <button type="button" class="p-2 rounded-lg shadow-sm hover:shadow-md bg-red-500"
                                    ...
                                    <div class="space-y-6">
                                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                                            <div
                                                ...
                                                <p class="text-xs uppercase tracking-wide text-gray-500">Asignar EPI
                                                </p>
                                                                    ...
                                                                    <template x-for="e in epiAssignSuggestions"
                                                                        ...
                                                                        <button type="button"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <template x-if="!e.imagen_url">
                                                                                    <span
                                                                                        class="text-gray-500 text-xs">Sin
                                                                                        img</span>
                                                                                </template>
                                                                            </div>
                                                                            <div class="min-w-0 flex-1">
                                        ...
                                        <div
                                            ...
                                            <template
                                                x-if="!loadingAsignaciones && asignacionesEnPosesion.length === 0">
                ...
                <div
                    ...
                    <div class="p-5 space-y-4 overflow-y-auto">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1">Si dejas el campo vac?o no se aplicar? ning?n cambio.
                            </p>
                        </div>
                    </div>
                            ...
                            <div class="sm:col-span-4">
                                ...
                                <div class="relative" data-compras-filter-epi-suggest>
                                    ...
                                    <div x-show="comprasFilterEpiSuggestionsOpen"
                                        class="absolute z-50 mt-2 w-full bg-white/95 border border-slate-200 shadow-xl rounded-xl overflow-hidden">
                                        <div class="max-h-80 overflow-y-auto">
                    ...
                    <div class="p-6 overflow-y-auto space-y-6">
                        <div class="bg-slate-50 border border-slate-200 rounded-xl p-4">
                            ...
                            <div class="mt-4 grid grid-cols-1 sm:grid-cols-6 gap-3">
                                ...
                                <div class="sm:col-span-2">
                                    <label class="block text-xs font-medium text-gray-700 mb-1">Ticket
                                        (opcional)</label>
                                    <input type="file" accept="image/*,application/pdf"
                                        @change="compraTicketFile = $event.target.files?.[0] || null"
                                        class="w-full text-sm" />
                                    <template x-if="compraTicketUrl">
                                        <a class="text-xs text-blue-700 hover:underline mt-1 inline-block"
                                            target="_blank" :href="compraTicketUrl">Ver ticket actual</a>
                                    </template>
                                </div>
                            </div>
                        </div>
            ...
            <div x-show="activeView === 'tallas'" x-transition:enter="transition ease-out duration-300"
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-4 mb-5">
                            ...
                            <div>
                                <h4 class="text-[10px] font-black uppercase tracking-widest text-gray-400">Guantes</h4>
                                <p class="text-xs font-bold text-gray-900"
                                    x-text="Object.keys(tallasStats.guante).length + ' tallas distintas'"></p>
                            </div>
                        </div>
                        <div class="space-y-2 max-h-48 overflow-y-auto pr-2 custom-scrollbar">
                            <template x-for="(count, size) in tallasStats.guante" :key="size">
                                <div
                                    class="flex items-center justify-between p-2 rounded-xl border border-gray-50 hover:bg-blue-50/30 transition-colors">
                                    <span class="text-xs font-black text-gray-700" x-text="size"></span>
                                    <span
                                        class="px-2 py-0.5 bg-blue-100/50 text-blue-600 rounded-lg text-[10px] font-black"
                                        x-text="count + ' pers.'"></span>
                                </div>
                            </template>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-4 mb-5">
                            ...
                            <div>
                                <h4 class="text-[10px] font-black uppercase tracking-widest text-gray-400">Calzado</h4>
                                <p class="text-xs font-bold text-gray-900"
                                    x-text="Object.keys(tallasStats.zapato).length + ' tallas distintas'"></p>
                            </div>
                        </div>
                        <div class="space-y-2 max-h-48 overflow-y-auto pr-2 custom-scrollbar">
                            <template x-for="(count, size) in tallasStats.zapato" :key="size">
                                <div
                                    class="flex items-center justify-between p-2 rounded-xl border border-gray-50 hover:bg-emerald-50/30 transition-colors">
                                    <span class="text-xs font-black text-gray-700" x-text="size"></span>
                                    <span
                                        class="px-2 py-0.5 bg-emerald-100/50 text-emerald-600 rounded-lg text-[10px] font-black"
                                        x-text="count + ' pers.'"></span>
                                </div>
                            </template>
                        </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-4 mb-5">
                            ...
                            <div>
                                <h4 class="text-[10px] font-black uppercase tracking-widest text-gray-400">Pantalón
                                </h4>
                                <p class="text-xs font-bold text-gray-900"
                                    x-text="Object.keys(tallasStats.pantalon).length + ' tallas distintas'"></p>
                            </div>
                        </div>
                        <div class="space-y-2 max-h-48 overflow-y-auto pr-2 custom-scrollbar">
                            <template x-for="(count, size) in tallasStats.pantalon" :key="size">
                                <div
                                    class="flex items-center justify-between p-2 rounded-xl border border-gray-50 hover:bg-amber-50/30 transition-colors">
                                    <span class="text-xs font-black text-gray-700" x-text="size"></span>
                                    <span
                                        class="px-2 py-0.5 bg-amber-100/50 text-amber-600 rounded-lg text-[10px] font-black"
                                        x-text="count + ' pers.'"></span>
                                </div>
                            </template>
                        </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-4 mb-5">
                            ...
                            <div>
                                <h4 class="text-[10px] font-black uppercase tracking-widest text-gray-400">Chaqueta
                                </h4>
                                <p class="text-xs font-bold text-gray-900"
                                    x-text="Object.keys(tallasStats.chaqueta).length + ' tallas distintas'"></p>
                            </div>
                        </div>
                        <div class="space-y-2 max-h-48 overflow-y-auto pr-2 custom-scrollbar">
                            <template x-for="(count, size) in tallasStats.chaqueta" :key="size">
                                <div
                                    class="flex items-center justify-between p-2 rounded-xl border border-gray-50 hover:bg-rose-50/30 transition-colors">
                                    <span class="text-xs font-black text-gray-700" x-text="size"></span>
                                    <span
                                        class="px-2 py-0.5 bg-rose-100/50 text-rose-600 rounded-lg text-[10px] font-black"
                                        x-text="count + ' pers.'"></span>
                                </div>
                            </template>
                        </div>
                ...
                <div
                    ...
                    <div
                        class="absolute inset-0 bg-gradient-to-br from-blue-500/5 via-transparent to-transparent opacity-0 group-hover/table:opacity-100 transition-opacity duration-500 pointer-events-none">
                    </div>

                    <div
                        class="px-8 py-6 border-b border-gray-100 bg-gray-50/50 flex flex-col sm:flex-row sm:items-center justify-between gap-4 relative z-10">
                        <div>
                            <h3 class="text-xl font-black text-gray-800 italic uppercase">Listado Detallado</h3>
                            <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest">Cruze de
                                trabajadores y tallas asignadas</p>
                        </div>
                        <div class="flex items-center gap-3">
                            <div
                                class="px-4 py-2 bg-white rounded-2xl border border-gray-100 shadow-sm flex items-center gap-3">
                                <div class="w-2 h-2 rounded-full bg-blue-500 animate-pulse"></div>
                                <span class="text-xs font-black text-gray-600 uppercase tracking-tight"
                                    x-text="usersWithTallas.length + ' Usuarios'"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="overflow-x-auto relative z-10">
                        <table class="w-full">
                            <thead>
                                <tr
                                    class="text-[10px] font-black uppercase tracking-widest text-gray-400 border-b border-gray-50 bg-white">
                                    <th class="px-8 py-5 text-left">Trabajador</th>
                                    <th class="px-6 py-5 text-center">Guante</th>
                                    <th class="px-6 py-5 text-center">Calzado</th>
                                    <th class="px-6 py-5 text-center">Pantalón</th>
                                    <th class="px-6 py-5 text-center">Chaqueta</th>
                                    <th class="px-8 py-5 text-right">Acciones</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-50 bg-white">
                                <template x-for="u in usersWithTallas" :key="u.id">
                                    <tr class="hover:bg-blue-50/20 transition-all duration-300 group/row">
                                        <td class="px-8 py-4">
                                            <div class="flex items-center gap-4">
                                                <div class="relative">
                                                    <div
                                                        class="w-12 h-12 rounded-2xl bg-gray-100 flex items-center justify-center overflow-hidden ring-2 ring-transparent group-hover/row:ring-blue-100 transition-all shadow-sm">
                                                        <template x-if="u.ruta_imagen"><img :src="u.ruta_imagen"
                                                                class="w-full h-full object-cover"></template>
                                                        <template x-if="!u.ruta_imagen"><span
                                                                class="text-lg font-black text-gray-300 uppercase"
                                                                x-text="u.nombre_completo?.slice(0,1)"></span></template>
                                                    </div>
                                                </div>
                                                <div class="min-w-0">
                                                    <p class="font-black text-gray-900 group-hover/row:text-blue-700 transition-colors"
                                                        x-text="u.nombre_completo"></p>
                                                    <p class="text-[10px] font-black text-gray-400 uppercase tracking-wider mt-0.5"
                                                        x-text="u.categoria?.nombre || 'General'"></p>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 text-center">
                                            <template x-if="u.tallas.talla_guante">
                                                <span
                                                    class="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-blue-50 text-blue-700 text-xs font-black ring-1 ring-blue-100/50"
                                                    x-text="u.tallas.talla_guante"></span>
                                            </template>
                                            <template x-if="!u.tallas.talla_guante">
                                                <span class="text-gray-300 text-[10px] font-black">—</span>
                                            </template>
                                        </td>
                                        <td class="px-6 py-4 text-center">
                                            <template x-if="u.tallas.talla_zapato">
                                                <span
                                                    class="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-emerald-50 text-emerald-700 text-xs font-black ring-1 ring-emerald-100/50"
                                                    x-text="u.tallas.talla_zapato"></span>
                                            </template>
                                            <template x-if="!u.tallas.talla_zapato">
                                                <span class="text-gray-300 text-[10px] font-black">—</span>
                                            </template>
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            <template x-if="u.tallas.talla_pantalon">
                                                <span
                                                    class="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-amber-50 text-amber-700 text-xs font-black ring-1 ring-amber-100/50"
                                                    x-text="u.tallas.talla_pantalon"></span>
                                            </template>
                                            <template x-if="!u.tallas.talla_pantalon">
                                                <span class="text-gray-300 text-[10px] font-black">—</span>
                                            </template>
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            <template x-if="u.tallas.talla_chaqueta">
                                                <span
                                                    class="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-rose-50 text-rose-700 text-xs font-black ring-1 ring-rose-100/50"
                                                    x-text="u.tallas.talla_chaqueta"></span>
                                            </template>
                                            <template x-if="!u.tallas.talla_chaqueta">
                                                <span class="text-gray-300 text-[10px] font-black">—</span>
                                            </template>
                                        ...
                                        <td class="px-8 py-4 text-right">
                                            <button @click="openUser(u)"
                                                class="p-3 bg-gray-50 text-gray-400 hover:bg-blue-600 hover:text-white rounded-2xl transition-all duration-300 transform active:scale-95">
                ...
                return {
                    ...
                    get usersWithTallas() {
                        ...
                        return this.allUsers.filter(u => {
                            const hasTallas = u.tallas && (u.tallas.talla_guante || u.tallas.talla_zapato || u
                                .tallas.talla_pantalon || u.tallas.talla_chaqueta);
                            if (!hasTallas) return false;

                            // Filtros de agenda sincronizados
                            if (this.agendaEmpresaId && u.empresa_id != this.agendaEmpresaId) return false;
                            if (this.agendaCategoriaId && u.categoria_id != this.agendaCategoriaId) return false;
                    ...
                    get tallasStats() {
                        ...
                        this.usersWithTallas.forEach(u => {
                            const t = u.tallas;
                            if (t.talla_guante) stats.guante[t.talla_guante] = (stats.guante[t.talla_guante] || 0) +
                                1;
                            if (t.talla_zapato) stats.zapato[t.talla_zapato] = (stats.zapato[t.talla_zapato] || 0) +
                                1;
                            if (t.talla_pantalon) stats.pantalon[t.talla_pantalon] = (stats.pantalon[t
                                .talla_pantalon] || 0) + 1;
                            if (t.talla_chaqueta) stats.chaqueta[t.talla_chaqueta] = (stats.chaqueta[t
                                .talla_chaqueta] || 0) + 1;
                        });

                        // Ordenar tallas alfabéticamente/numéricamente
                        ...
                        return {
                            guante: sortObj(stats.guante),
                            zapato: sortObj(stats.zapato),
                            pantalon: sortObj(stats.pantalon),
                            chaqueta: sortObj(stats.chaqueta)
                        };
                    },
