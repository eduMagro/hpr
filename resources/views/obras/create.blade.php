<x-app-layout>
                    ...
                    <div class="card-body">
                        <form action="{{ route('obras.store') }}" method="POST">
                            ...
                            <div class="form-group mb-4">
                                <label for="obra" class="form-label fw-bold text-uppercase">Nombre de la Obra *</label>
 ...
 <div class="form-group mb-4">
    ...
    <input type="text" id="cod_obra" name="cod_obra" class="form-control form-control-lg"
        placeholder="Introduce el código de la obra" value="{{ old('cod_obra') }}" required>
</div>
  ...
  <!-- Código Cliente -->
  <div class="form-group mb-4">
    <label for="cod_cliente" class="form-label fw-bold text-uppercase">Código Cliente</label>
    <input type="text" id="cod_cliente" name="cod_cliente" class="form-control form-control-lg"
        placeholder="Introduce el código del cliente" value="{{ old('cod_cliente') }}">
</div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" id="longitud" name="longitud" class="form-control form-control-lg"
                                    placeholder="Introduce la longitud" value="{{ old('longitud') }}">
                            </div>

                            <!-- Distancia -->
                            <div class="form-group mb-4">
                                <label for="distancia" class="form-label fw-bold text-uppercase">Radio (en metros)</label>
                                <input type="number" id="distancia" name="distancia" class="form-control form-control-lg"
                                    placeholder="Introduce la distancia permitida" value="{{ old('distancia') }}">
                            </div>
