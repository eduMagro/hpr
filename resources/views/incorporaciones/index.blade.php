    ...
    <div class="w-full max-w-7xl mx-auto py-6 px-4 sm:px-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            <div class="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-700 rounded-lg p-4">
                <div class="text-2xl font-bold text-yellow-700 dark:text-yellow-400">{{ $stats['pendientes'] }}</div>
                <div class="text-sm text-yellow-600 dark:text-yellow-500">Pendientes</div>
            </div>
            <div class="bg-orange-50 dark:bg-orange-900/30 border border-orange-200 dark:border-orange-700 rounded-lg p-4">
                <div class="text-2xl font-bold text-orange-700 dark:text-orange-400">{{ $stats['datos_recibidos'] }}</div>
                <div class="text-sm text-orange-600 dark:text-orange-500">Datos recibidos</div>
            </div>
            <div class="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-lg p-4">
                <div class="text-2xl font-bold text-blue-700 dark:text-blue-400">{{ $stats['en_proceso'] }}</div>
                <div class="text-sm text-blue-600 dark:text-blue-500">En proceso</div>
            </div>
            <div class="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 rounded-lg p-4">
                <div class="text-2xl font-bold text-green-700 dark:text-green-400">{{ $stats['completadas'] }}</div>
                <div class="text-sm text-green-600 dark:text-green-500">Completadas</div>
            </div>
        </div>
            ...
            <form method="GET" action="{{ route('incorporaciones.index') }}" class="flex flex-wrap gap-4">
                <div class="flex-1 min-w-[200px]">
                    <input type="text" name="buscar" value="{{ request('buscar') }}"
                        ...
                        class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 dark:placeholder-gray-400 focus:border-blue-500 focus:ring-blue-500">
                </div>
                <div>
                    <select name="estado" class="rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:border-blue-500 focus:ring-blue-500">
                ...
                <div>
                    <select name="empresa" class="rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:border-blue-500 focus:ring-blue-500">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <label for="no_asignado" class="text-sm text-gray-700 dark:text-gray-300">Sin asignar</label>
                </div>
                <button type="submit" class="px-4 py-2 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 rounded-lg transition">
                    Filtrar
                </button>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">Candidato
                                </th>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">Documentos
                                </th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">Usuario</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">Fecha Inc.
                                </th>
                            ...
                            @foreach ($incorporaciones as $inc)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        @if ($inc->user_id)
                                            <span
                                                class="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 dark:bg-green-900/50 text-green-800 dark:text-green-300">
                                                <div class="w-1.5 h-1.5 rounded-full bg-green-500"></div>
                                                Asignado
                                            </span>
                                        @else
                                            <span
                                                class="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 dark:bg-red-900/50 text-red-800 dark:text-red-300">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        @else
                                            <span
                                                class="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-medium bg-amber-100 dark:bg-amber-900/50 text-amber-800 dark:text-amber-300 border border-amber-300 dark:border-amber-700">
