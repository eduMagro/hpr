<x-app-layout>
    ...
    <x-page-header
        ...
        subtitle="Gestión e importación de planillas"
    ...
    <script>
        ...
        function initModal() {
            ...
            if (!btnAbrir || !modal || !overlay || !btnCancel || !form || !inputFecha) {
                ...
                if (modalInitAttempts < 50) {
                    ...
                    console.warn('No se encontraron los elementos del modal tras varios intentos, deteniendo.');
                }
                return;
            }
            ...
            if (modalInitialized) {
                console.log('Modal ya inicializado, saltando...');
                return;
            }
        ...
        window.resetearPlanilla = async function(planillaId, codigoPlanilla) {
            ...
            if (typeof Swal !== 'undefined') {
                const result = await Swal.fire({
                    title: `¿Resetear planilla ${codigoPlanilla}?`,
        ...
        function initCompletarTodas() {
            ...
            // Agregar evento a ambos botones
            if (btnCompletar) {
