<x-app-layout>
    ...
    <div class="w-full px-6 py-4">
        <div class="flex flex-wrap items-center gap-x-4 gap-y-2 mb-4">
            ...
            {{-- Modal + FORM (el form vive dentro del modal) --}}
            <div id="modal-import" class="fixed inset-0 z-[60] hidden">
                ...
                <div
                    ...
                    <p class="text-sm text-gray-600 mb-4">
                        Selecciona el archivo y el <b>día de aprobación</b>. La
                        <b>fecha estimada de entrega</b> se calculará como
                        <b>aprobación + 7 días</b>.
                    </p>

                    {{-- FORMULARIO REAL (se envía al confirmar) --}}
            ...
            <script>
                (function() {
                    ...
                    // (Opcional) Bloquear UI mientras envía
                    form.addEventListener('submit', function() {
                        // cierra modal y podrías añadir un overlay general si quieres
                        cerrar();
                    });
                })();
            </script>
