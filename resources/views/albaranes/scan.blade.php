                ...
                <div class="space-y-3">
                    ...
                    <div class="space-y-2 text-sm">
                        ...
                        <div>
                            ...
                            <span class="font-medium text-gray-900">${lineaPropuesta.producto_base.tipo || '—'} ${'Ø' + lineaPropuesta.producto_base.diametro || ''} ${lineaPropuesta.producto_base.longitud + 'm' || ''}</span>
                        </div>
                        <div>
