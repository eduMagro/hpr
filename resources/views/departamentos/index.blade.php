<x-app-layout>
    ...
    <div class="py-4 relative flex flex-col gap-8" x-data="{
        openModal: false,
                            ...
                            <tr class="hover:bg-blue-50/50 dark:hover:bg-blue-900/10 transition-colors duration-150">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <button @click="isExpanded = !isExpanded"
                                        ...
                                        <div
                                            class="w-2 h-2 rounded-full bg-blue-500 shadow-[0_0_8px_rgba(59,130,246,0.5)] group-hover:scale-125 transition-transform shrink-0">
                                        </div>
                                        <span
                ...
                <table id="tabla-secciones" class="w-full min-w-[800px] border-collapse">
                    ...
                    <tbody>
                        @foreach ($todasLasSecciones as $sec)
                            <tr data-seccion-id="{{ $sec->id }}" x-data="{
                                                                            editando: false,
                                                                            seccion: @js($sec),
                                ...
                                class="border-b dark:border-gray-700 last:border-0 cursor-pointer hover:bg-indigo-50/50 dark:hover:bg-indigo-900/10 focus:outline-none transition-colors"
                                tabindex="0">
                    ...
                    <div class="bg-gradient-to-r from-amber-500 to-orange-500 px-6 py-4">
                        <div class="flex items-center justify-between flex-wrap gap-3">
                            ...
                            <button @click="sincronizarTodas()" :disabled="sincronizando || seccionesFaltantes.length === 0"
                                ...
                                <svg x-show="sincronizando" class="animate-spin w-5 h-5 mr-2" fill="none"
                                    viewBox="0 0 24 24">
                            ...
                            <template x-for="item in seccionesFaltantes" :key="item.prefijo">
                                <div
                                    ...
                                    <button @click="crearSeccion(item.prefijo, item.nombre_sugerido)"
                                        ...
                                        <svg x-show="creandoPrefijo === item.prefijo" class="animate-spin w-4 h-4"
                                ...
                                <div
                                    ...
                                    @foreach ($roles as $rol)
                                        <label
                                            ...
                                            <span
                                                class="text-sm text-gray-700 dark:text-gray-300 uppercase">{{ $rol }}</span>
                                        </label>
                                    @endforeach
                                </div>
                            </div>
                                        ...
                                        @foreach ($todosUsuarios as $usuario)
                                            <label
                                                ...
                                                <img src="{{ $usuario->ruta_imagen }}"
                                                    class="w-8 h-8 rounded-full object-cover" alt="" onerror="this.onerror=null; this.outerHTML=`<svg xmlns='' width='28' height='28'
