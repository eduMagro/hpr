    ...
    <div class="py-4 lg:py-12 ">
        <div class="max-w-7xl mx-auto">
            <div>
                <div>
                    <div
                        class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 justify-items-center">

                        @foreach ($items as $index => $item)
                            <a href="{{ $item['route'] ? route($item['route']) : '#' }}" wire:navigate
                                class="dashboard-icon w-32 h-32 bg-white dark:bg-gray-600/20 rounded-2xl shadow-md flex flex-col items-center justify-center text-center hover:shadow-xl hover:scale-105 hover:-translate-y-1 transition-all duration-300 ease-out relative group"
