...
}" x-cloak class="bg-gray-900 dark:bg-gray-950 border-b border-gray-800 dark:border-gray-700 shadow-sm flex-shrink-0 transition-colors">
    ...
    <div class="w-full">
        <div class="flex justify-between items-center h-14">
            ...
            <div class="flex items-center space-x-4 relative overflow-hidden">
                ...
                <a x-show="!sidebarOpen && !isToggling"
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open"
                        ...
                        <div class="px-4 py-2 border-b border-gray-800 dark:border-gray-700">
                            ...
                            <p class="text-xs text-gray-400 dark:text-gray-400">Accede rápidamente a funciones comunes</p>
                        </div>
            ...
            <div class="flex items-center space-x-2 sm:space-x-4">
                ...
                <div class="relative" x-data="{ open: false }">
                    <button @click="open = !open"
                        ...
                        <div class="w-8 h-8 bg-gray-900 dark:bg-gray-950 rounded-full flex items-center justify-center text-white font-bold text-sm border-2 border-gray-300">
                    ...
                    <div x-show="open"
                        ...
                        <div class="px-4 py-3 border-b border-gray-800 dark:border-gray-700">
                            <p class="text-sm font-medium text-gray-300 dark:text-white">{{ Auth::user()->nombre_completo }}</p>
