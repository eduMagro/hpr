                ...
                <thead class="bg-blue-500 text-white">
                    <tr class="text-left text-sm uppercase">
                        ...
                        <th class="px-4 py-3 border">Planilla
						 <form method="GET" action="{{ route('subpaquetes.index') }}" class="mt-2">
                                <input type="text" name="planilla" class="w-full px-2 py-1 text-gray-900 rounded-md border border-gray-300 focus:ring-2 focus:ring-blue-500" placeholder="Buscar">
                            </form>
						</th>
                        <th class="px-4 py-3 border">Paquete
						 <form method="GET" action="{{ route('subpaquetes.index') }}" class="mt-2">
                                <input type="text" name="paquete" class="w-full px-2 py-1 text-gray-900 rounded-md border border-gray-300 focus:ring-2 focus:ring-blue-500" placeholder="Buscar">
                            </form>
						</th>
                        <th class="px-4 py-3 border">Elemento
						   <form method="GET" action="{{ route('subpaquetes.index') }}" class="mt-2">
                                <input type="text" name="elemento" class="w-full px-2 py-1 text-gray-900 rounded-md border border-gray-300 focus:ring-2 focus:ring-blue-500" placeholder="Buscar">
                            </form>
						</th>
                    ...
                    @forelse ($subpaquetes as $subpaquete)
                        <tr class="border-b odd:bg-gray-100 even:bg-gray-50 hover:bg-blue-200">
                           ...
                           <td class="px-4 py-3 text-center border">
                                    ...
                                    <a href="{{ route('subpaquetes.edit', $subpaquete->id) }}" class="text-yellow-500 hover:underline">Editar</a>
