import{o as Se,a as Ee}from"./livewire-helper.ByMpYwFv.js";const oe=8,ke=6e4;let M=new Map,H=new Map;function $e(e,a){return`${e}|${a.startStr}|${a.endStr}`}function Ce(e){return Date.now()-e.timestamp>ke}function qe(){if(M.size>oe){const e=Array.from(M.entries()).sort((t,o)=>t[1].timestamp-o[1].timestamp);e.slice(0,e.length-oe).forEach(([t])=>M.delete(t))}}async function ae(e,a){var r,d;const t=(d=(r=window.AppSalidas)==null?void 0:r.routes)==null?void 0:d.planificacion;if(!t)return{events:[],resources:[],totales:null};const o=$e(e,a),n=M.get(o);if(n&&!Ce(n))return n.data;if(H.has(o))return H.get(o);const i=(async()=>{try{const l=new URLSearchParams({tipo:"all",viewType:e||"",start:a.startStr||"",end:a.endStr||""}),u=await fetch(`${t}?${l.toString()}`);if(!u.ok)throw new Error(`HTTP ${u.status}`);const p=await u.json(),h={events:p.events||[],resources:p.resources||[],totales:p.totales||null};return M.set(o,{data:h,timestamp:Date.now()}),qe(),h}catch(l){return console.error("fetch all data falló:",l),{events:[],resources:[],totales:null}}finally{H.delete(o)}})();return H.set(o,i),i}function F(){M.clear(),H.clear()}function Le(e){var r,d;const a=((r=document.getElementById("solo-salidas"))==null?void 0:r.checked)||!1,t=((d=document.getElementById("solo-planillas"))==null?void 0:d.checked)||!1,o=e.filter(l=>{var u;return((u=l.extendedProps)==null?void 0:u.tipo)==="resumen-dia"}),n=e.filter(l=>{var u;return((u=l.extendedProps)==null?void 0:u.tipo)!=="resumen-dia"});let i=n;return a&&!t?i=n.filter(l=>{var u;return((u=l.extendedProps)==null?void 0:u.tipo)==="salida"}):t&&!a&&(i=n.filter(l=>{var p;const u=(p=l.extendedProps)==null?void 0:p.tipo;return u==="planilla"||u==="festivo"})),[...i,...o]}async function Te(e,a){const t=await ae(e,a);return Le(t.events)}async function _e(e,a){return(await ae(e,a)).resources}async function Ae(e,a){const t=await ae(e,a);if(!t.totales)return;const{semana:o,mes:n}=t.totales,i=c=>c!=null?Number(c).toLocaleString():"0",r=document.querySelector("#resumen-semanal-peso"),d=document.querySelector("#resumen-semanal-longitud"),l=document.querySelector("#resumen-semanal-diametro"),u=document.querySelector("#resumen-semanal-fecha");r&&(r.textContent=`${i(o==null?void 0:o.peso)} kg`),d&&(d.textContent=`${i(o==null?void 0:o.longitud)} m`),l&&(l.textContent=o!=null&&o.diametro?`⌀ ${Number(o.diametro).toFixed(2)} mm`:""),u&&(o!=null&&o.nombre)&&(u.textContent=`(${o.nombre})`);const p=document.querySelector("#resumen-mensual-peso"),h=document.querySelector("#resumen-mensual-longitud"),b=document.querySelector("#resumen-mensual-diametro"),s=document.querySelector("#resumen-mensual-fecha");p&&(p.textContent=`${i(n==null?void 0:n.peso)} kg`),h&&(h.textContent=`${i(n==null?void 0:n.longitud)} m`),b&&(b.textContent=n!=null&&n.diametro?`⌀ ${Number(n.diametro).toFixed(2)} mm`:""),s&&(n!=null&&n.nombre)&&(s.textContent=`(${n.nombre})`)}function ne(e,a){const t=e.event.extendedProps||{};if(t.tipo!=="festivo"){if(t.tipo==="planilla"){const o=`
      ✅ Fabricados: ${U(t.fabricadosKg)} kg<br>
      🔄 Fabricando: ${U(t.fabricandoKg)} kg<br>
      ⏳ Pendientes: ${U(t.pendientesKg)} kg
    `;tippy(e.el,{content:o,allowHTML:!0,theme:"light-border",placement:"top",animation:"shift-away",arrow:!0})}t.tipo==="salida"&&t.comentario&&t.comentario.trim()&&tippy(e.el,{content:t.comentario,allowHTML:!0,theme:"light-border",placement:"top",animation:"shift-away",arrow:!0})}}function U(e){return e!=null?Number(e).toLocaleString():0}let G=null;function A(){G&&(G.remove(),G=null,document.removeEventListener("click",A),document.removeEventListener("contextmenu",A,!0),document.removeEventListener("scroll",A,!0),window.removeEventListener("resize",A),window.removeEventListener("keydown",pe))}function pe(e){e.key==="Escape"&&A()}function De(e,a,t){A();const o=document.createElement("div");o.className="fc-contextmenu",Object.assign(o.style,{position:"fixed",top:a+"px",left:e+"px",zIndex:99999,minWidth:"240px",background:"#fff",border:"1px solid #e5e7eb",boxShadow:"0 10px 15px -3px rgba(0,0,0,.1), 0 4px 6px -2px rgba(0,0,0,.05)",borderRadius:"8px",overflow:"hidden",fontFamily:"system-ui, -apple-system, Segoe UI, Roboto, sans-serif"}),o.innerHTML=t,document.body.appendChild(o),G=o;const n=o.getBoundingClientRect(),i=Math.max(0,n.right-window.innerWidth+8),r=Math.max(0,n.bottom-window.innerHeight+8);return(i||r)&&(o.style.left=Math.max(8,e-i)+"px",o.style.top=Math.max(8,a-r)+"px"),setTimeout(()=>{document.addEventListener("click",A),document.addEventListener("contextmenu",A,!0),document.addEventListener("scroll",A,!0),window.addEventListener("resize",A),window.addEventListener("keydown",pe)},0),o}function Pe(e,a,{headerHtml:t="",items:o=[]}={}){const n=`
  ...
  `,document.head.appendChild(a)})();function Fe(e){const a=e.extendedProps||{};if(Array.isArray(a.planillas_ids)&&a.planillas_ids.length)return a.planillas_ids;const t=(e.id||"").match(/planilla-(\d+)/);return t?[Number(t[1])]:[]}async function ze(e,a){var t,o;try{A()}catch{}if(!e)return Swal.fire("⚠️","ID de salida inválido.","warning");try{const n=await fetch(`${(o=(t=window.AppSalidas)==null?void 0:t.routes)==null?void 0:o.informacionPaquetesSalida}?salida_id=${e}`,{headers:{Accept:"application/json"}});if(!n.ok)throw new Error("Error al cargar información de la salida");const{salida:i,paquetesAsignados:r,paquetesDisponibles:d,paquetesTodos:l,filtros:u}=await n.json();Me(i,r,d,l||[],u||{obras:[],planillas:[],obrasRelacionadas:[]},a)}catch(n){console.error(n),Swal.fire("❌","Error al cargar la información de la salida","error")}}function Me(e,a,t,o,n,i){window._gestionPaquetesData={salida:e,paquetesAsignados:a,paquetesDisponibles:t,paquetesTodos:o,filtros:n,mostrarTodos:!1};const r=Be(e,a,t,n);Swal.fire({title:`📦 Gestionar Paquetes - Salida ${e.codigo_salida||e.id}`,html:r,width:Math.min(window.innerWidth*.95,1200),showConfirmButton:!0,showCancelButton:!0,confirmButtonText:"💾 Guardar Cambios",cancelButtonText:"Cancelar",focusConfirm:!1,customClass:{popup:"w-full max-w-screen-xl"},didOpen:()=>{ge(),Oe(),We(),setTimeout(()=>{Ne()},100)},willClose:()=>{q.cleanup&&q.cleanup();const d=document.getElementById("modal-keyboard-indicator");d&&d.remove()},preConfirm:()=>Xe()}).then(async d=>{d.isConfirmed&&d.value&&await Ye(e.id,d.value,i)})}function Be(e,a,t,o){var u,p;const n=a.reduce((h,b)=>h+(parseFloat(b.peso)||0),0);let i="";e.salida_clientes&&e.salida_clientes.length>0&&(i='<div class="col-span-2"><strong>Obras/Clientes:</strong><br>',e.salida_clientes.forEach(h=>{var f,g,v,k,y;const b=((f=h.obra)==null?void 0:f.obra)||"Obra desconocida",s=(g=h.obra)!=null&&g.cod_obra?`(${h.obra.cod_obra})`:"",c=((v=h.cliente)==null?void 0:v.empresa)||((y=(k=h.obra)==null?void 0:k.cliente)==null?void 0:y.empresa)||"";i+=`<span class="text-xs">• ${b} ${s}`,c&&(i+=` - ${c}`),i+="</span><br>"}),i+="</div>");const r=`
    ...
    `,document.head.appendChild(e)}function fe(e){e.addEventListener("dragstart",a=>{e.style.opacity="0.5",a.dataTransfer.setData("text/plain",e.dataset.paqueteId)}),e.addEventListener("dragend",a=>{e.style.opacity="1"})}function ge(){document.querySelectorAll(".paquete-item-salida").forEach(e=>{fe(e)}),document.querySelectorAll(".drop-zone").forEach(e=>{e.addEventListener("dragover",a=>{a.preventDefault();const t=e.dataset.zona;e.style.backgroundColor=t==="asignados"?"#d1fae5":"#e0f2fe"}),e.addEventListener("dragleave",a=>{e.style.backgroundColor=""}),e.addEventListener("drop",a=>{a.preventDefault(),e.style.backgroundColor="";const t=a.dataTransfer.getData("text/plain"),o=document.querySelector(`.paquete-item-salida[data-paquete-id="${t}"]`);if(o){const n=e.querySelector(".placeholder-sin-paquetes");n&&n.remove(),e.appendChild(o),V()}})})}function V(){const e=document.querySelector('[data-zona="asignados"]'),a=e==null?void 0:e.querySelectorAll(".paquete-item-salida");let t=0;a==null||a.forEach(n=>{const i=parseFloat(n.dataset.peso)||0;t+=i});const o=document.getElementById("peso-asignados");o&&(o.textContent=`${t.toFixed(2)} kg`)}function Ge(){const e=document.querySelector('[data-zona="asignados"]'),a=document.querySelector('[data-zona="disponibles"]');if(!e||!a)return;const t=e.querySelectorAll(".paquete-item-salida");if(t.length===0)return;t.forEach(n=>{a.appendChild(n)});const o=a.querySelector(".placeholder-sin-paquetes");o&&o.remove(),e.querySelectorAll(".paquete-item-salida").length===0&&(e.innerHTML='<div class="text-gray-400 text-sm text-center py-4 placeholder-sin-paquetes">Sin paquetes</div>'),V()}function Ve(){const e=document.querySelector('[data-zona="asignados"]'),a=document.querySelector('[data-zona="disponibles"]');if(!e||!a)return;const t=Array.from(a.querySelectorAll(".paquete-item-salida")).filter(i=>i.style.display!=="none");if(t.length===0)return;const o=e.querySelector(".placeholder-sin-paquetes");o&&o.remove(),t.forEach(i=>{e.appendChild(i)}),a.querySelectorAll(".paquete-item-salida").length===0&&(a.innerHTML='<div class="text-gray-400 text-sm text-center py-4 placeholder-sin-paquetes">Sin paquetes</div>'),V()}window.vaciarSalidaModal=Ge;window.volcarTodosASalidaModal=Ve;function Xe(){const e=document.querySelector('[data-zona="asignados"]');return{paquetes_ids:Array.from((e==null?void 0:e.querySelectorAll(".paquete-item-salida"))||[]).map(t=>parseInt(t.dataset.paqueteId))}}async function Ye(e,a,t){var o,n,i,r;try{const l=await(await fetch((n=(o=window.AppSalidas)==null?void 0:o.routes)==null?void 0:n.guardarPaquetesSalida,{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":(i=window.AppSalidas)==null?void 0:i.csrf},body:JSON.stringify({salida_id:e,paquetes_ids:a.paquetes_ids})})).json();l.success?(await Swal.fire({icon:"success",title:"Cambios Guardados",text:"Los paquetes de la salida se han actualizado correctamente.",timer:2e3}),t&&(t.refetchEvents(),(r=t.refetchResources)==null||r.call(t))):await Swal.fire("⚠️",l.message||"No se pudieron guardar los cambios","warning")}catch(d){console.error(d),Swal.fire("❌","Error al guardar los paquetes","error")}}async function Ke(e,a,t){try{A()}catch{}window.Livewire.dispatch("abrirComentario",{salidaId:e}),window._calendarRef=t}function Je(e){return e?typeof e=="string"?e.split(",").map(t=>t.trim()).filter(Boolean):Array.from(e).map(t=>typeof t=="object"&&(t==null?void 0:t.id)!=null?t.id:t).map(String).map(t=>t.trim()).filter(Boolean):[]}async function Ue(e){var i,r;const a=(r=(i=window.AppSalidas)==null?void 0:i.routes)==null?void 0:r.informacionPlanillas;if(!a)throw new Error("Ruta 'informacionPlanillas' no configurada");const t=`${a}?ids=${encodeURIComponent(e.join(","))}`,o=await fetch(t,{headers:{Accept:"application/json"}});if(!o.ok){const d=await o.text().catch(()=>"");throw new Error(`GET ${t} -> ${o.status} ${d}`)}const n=await o.json();return Array.isArray(n==null?void 0:n.planillas)?n.planillas:[]}function ye(e){if(!e)return!1;const t=new Date(e+"T00:00:00").getDay();return t===0||t===6}function Ze(e,a,t,o){const n=document.getElementById("modal-figura-elemento-overlay");n&&n.remove();const i=o.getBoundingClientRect(),r=320,d=240;let l=i.right+10;l+r>window.innerWidth&&(l=i.left-r-10);let u=i.top-d/2+i.height/2;u<10&&(u=10),u+d>window.innerHeight-10&&(u=window.innerHeight-d-10);const p=`
    ...
    `;document.body.insertAdjacentHTML("beforeend",p),setTimeout(()=>{typeof window.dibujarFiguraElemento=="function"&&window.dibujarFiguraElemento(`figura-elemento-container-${e}`,t,null)},50)}function Qe(e){return`
    <div class="text-left">
...
${b}`}).join("")}</tbody>
    ...
    `}function tt(e,a){F();const t=new Set(a.eventos_eliminar||[]);(a.eventos_nuevos||[]).forEach(o=>t.add(o.id)),t.forEach(o=>{const n=e.getEventById(o);n&&n.remove()}),a.eventos_nuevos&&Array.isArray(a.eventos_nuevos)&&a.eventos_nuevos.forEach(o=>{const n=e.getEventById(o.id);n&&n.remove(),e.addEvent(o)}),a.resumenes_dias&&typeof window.actualizarResumenesDias=="function"&&window.actualizarResumenesDias(a.resumenes_dias),e.render()}async function at(e){var o,n,i;const a=(n=(o=window.AppSalidas)==null?void 0:o.routes)==null?void 0:n.actualizarFechasPlanillas;if(!a)throw new Error("Ruta 'actualizarFechasPlanillas' no configurada");const t=await fetch(a,{method:"PUT",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":(i=window.AppSalidas)==null?void 0:i.csrf,Accept:"application/json"},body:JSON.stringify({planillas:e})});if(!t.ok){const r=await t.text().catch(()=>"");throw new Error(`PUT ${a} -> ${t.status} ${r}`)}return t.json().catch(()=>({}))}async function ot(e,a){try{const t=Array.from(new Set(Je(e))).map(Number).filter(Boolean);if(!t.length)return Swal.fire("⚠️","No hay planillas en la agrupación.","warning");const o=await Ue(t);if(!o.length)return Swal.fire("⚠️","No se han encontrado planillas.","warning");const i=`
...
`)[0])||"",u=o.cliente||"",p=o.pesoTotal?Number(o.pesoTotal).toLocaleString("es-ES",{maximumFractionDigits:0}):"",h=o.longitudTotal?Number(o.longitudTotal).toLocaleString("es-ES",{maximumFractionDigits:0}):"",b=o.diametroMedio?Number(o.diametroMedio).toFixed(1):"",s=((f=a==null?void 0:a.style)==null?void 0:f.backgroundColor)||e.backgroundColor||"#6366f1";return t.innerHTML=`
    ...
    `;if(f.tipo==="planilla"){const y=f.pesoTotal!=null?`📦 ${Number(f.pesoTotal).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2})} kg`:null,E=f.longitudTotal!=null?`📏 ${Number(f.longitudTotal).toLocaleString()} m`:null,$=f.diametroMedio!=null?`⌀ ${Number(f.diametroMedio).toFixed(2)} mm`:null,m=[y,E,$].filter(Boolean);m.length>0&&(v+=`<div class="text-sm text-black font-semibold">${m.join(" | ")}</div>`),f.tieneSalidas&&Array.isArray(f.salidas_codigos)&&f.salidas_codigos.length>0&&(v+=`
            <div class="mt-2">
                <span class="text-black bg-yellow-400 rounded px-2 py-1 inline-block text-xs font-semibold">
                    Salidas: ${f.salidas_codigos.join(", ")}
            ...
            </div>`)}return v+="</div>",{html:v}},eventDidMount:function(s){var E,$,m,w,S;const c=s.event.extendedProps||{};if(s.el.setAttribute("draggable","false"),s.el.ondragstart=C=>(C.preventDefault(),!1),c.tipo==="resumen-dia"){s.el.classList.add("evento-resumen-diario"),s.el.style.cursor="default";return}if(s.view.type==="dayGridMonth"){const C=s.el.closest(".fc-daygrid-event-harness");C&&C.classList.add("evento-fullwidth"),s.el.classList.add("evento-fullwidth-event")}const f=(((E=document.getElementById("filtro-obra"))==null?void 0:E.value)||"").trim().toLowerCase(),g=((($=document.getElementById("filtro-nombre-obra"))==null?void 0:$.value)||"").trim().toLowerCase(),v=(((m=document.getElementById("filtro-cod-cliente"))==null?void 0:m.value)||"").trim().toLowerCase(),k=(((w=document.getElementById("filtro-cliente"))==null?void 0:w.value)||"").trim().toLowerCase(),y=(((S=document.getElementById("filtro-cod-planilla"))==null?void 0:S.value)||"").trim().toLowerCase();if(f||g||v||k||y){let C=!1;if(c.tipo==="salida"&&c.obras&&Array.isArray(c.obras)){if(C=c.obras.some(L=>{const T=(L.codigo||"").toString().toLowerCase(),_=(L.nombre||"").toString().toLowerCase(),P=(L.cod_cliente||"").toString().toLowerCase(),X=(L.cliente||"").toString().toLowerCase(),Y=!f||T.includes(f),K=!g||_.includes(g),J=!v||P.includes(v),R=!k||X.includes(k);return Y&&K&&J&&R}),y&&c.planillas_codigos&&Array.isArray(c.planillas_codigos)){const L=c.planillas_codigos.some(T=>(T||"").toString().toLowerCase().includes(y));C=C&&L}}else{const L=(c.cod_obra||"").toString().toLowerCase(),T=(c.nombre_obra||s.event.title||"").toString().toLowerCase(),_=(c.cod_cliente||"").toString().toLowerCase(),P=(c.cliente||"").toString().toLowerCase(),X=!f||L.includes(f),Y=!g||T.includes(g),K=!v||_.includes(v),J=!k||P.includes(k);let R=!0;y&&(c.planillas_codigos&&Array.isArray(c.planillas_codigos)?R=c.planillas_codigos.some(xe=>(xe||"").toString().toLowerCase().includes(y)):R=(s.event.title||"").toLowerCase().includes(y)),C=X&&Y&&K&&J&&R}C?(s.el.classList.add("evento-filtrado"),s.el.classList.remove("evento-atenuado")):(s.el.classList.add("evento-atenuado"),s.el.classList.remove("evento-filtrado"))}else s.el.classList.remove("evento-filtrado"),s.el.classList.remove("evento-atenuado");typeof ne=="function"&&ne(s),typeof re=="function"&&re(s,x)},eventAllow:(s,c)=>{var g;const f=(g=c.extendedProps)==null?void 0:g.tipo;return!(f==="resumen-dia"||f==="festivo")},snapDuration:"00:30:00",eventDragStart:s=>{var $;window._isDragging=!0,window._draggedEvent=s.event,lt(s.event,s.el),document.body.classList.add("fc-dragging-active");const c=rt(),f=m=>{m.dataTransfer&&window._isDragging&&m.dataTransfer.setDragImage(c,0,0)};document.addEventListener("dragstart",f,!0),window._nativeDragStartHandler=f;const g=document.getElementById("calendario");(($=x==null?void 0:x.view)==null?void 0:$.type)==="resourceTimeGridDay"&&ce(!0);const v=(m,w)=>{const S=document.elementsFromPoint(m,w);for(const C of S){const L=C.closest(".fc-daygrid-day");if(L)return L.getAttribute("data-date");const T=C.closest("[data-date]");if(T)return T.getAttribute("data-date")}return null};let k=!1;const y=m=>{!window._isDragging||k||(k=!0,requestAnimationFrame(()=>{if(k=!1,!window._isDragging)return;const w=de(m.clientY,g),S=v(m.clientX,m.clientY);le(m.clientX,m.clientY,w,S)}))};if(document.addEventListener("mousemove",y,{passive:!0}),window._dragMouseMoveHandler=y,s.jsEvent){const m=de(s.jsEvent.clientY,g),w=v(s.jsEvent.clientX,s.jsEvent.clientY);le(s.jsEvent.clientX,s.jsEvent.clientY,m,w)}window._dragOriginalStart=s.event.start,window._dragOriginalEnd=s.event.end,window._dragEventId=s.event.id;const E=m=>{if(window._isDragging){m.preventDefault(),m.stopPropagation(),m.stopImmediatePropagation(),window._cancelDrag=!0,ee();const w=new PointerEvent("pointerup",{bubbles:!0,cancelable:!0,clientX:m.clientX,clientY:m.clientY});document.dispatchEvent(w)}};document.addEventListener("contextmenu",E,{capture:!0}),window._dragContextMenuHandler=E},eventDragStop:s=>{window._isDragging=!1,window._draggedEvent=null,window._nativeDragStartHandler&&(document.removeEventListener("dragstart",window._nativeDragStartHandler,!0),window._nativeDragStartHandler=null),window._dragMouseMoveHandler&&(document.removeEventListener("mousemove",window._dragMouseMoveHandler),window._dragMouseMoveHandler=null),window._dragContextMenuHandler&&(document.removeEventListener("contextmenu",window._dragContextMenuHandler,{capture:!0}),window._dragContextMenuHandler=null),window._dragOriginalStart=null,window._dragOriginalEnd=null,window._dragEventId=null,ee(),document.body.classList.remove("fc-dragging-active"),ce(!1)},eventDrop:s=>{var y,E,$,m;if(window._cancelDrag){window._cancelDrag=!1,s.revert(),window._dragOriginalStart&&(s.event.setStart(window._dragOriginalStart),window._dragOriginalEnd&&s.event.setEnd(window._dragOriginalEnd));return}const c=s.event.extendedProps||{},f=s.event.id,g=(y=s.event.start)==null?void 0:y.toISOString(),v={fecha:g,tipo:c.tipo,planillas_ids:c.planillas_ids||[],elementos_ids:c.elementos_ids||[],verificar_fabricacion:!0},k=((($=(E=window.AppSalidas)==null?void 0:E.routes)==null?void 0:$.updateItem)||"").replace("__ID__",f);Swal.fire({title:"Actualizando fecha...",allowOutsideClick:!1,allowEscapeKey:!1,showConfirmButton:!1,didOpen:()=>{Swal.showLoading()}}),fetch(k,{method:"PUT",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":(m=window.AppSalidas)==null?void 0:m.csrf},body:JSON.stringify(v)}).then(w=>{if(!w.ok)throw new Error("No se pudo actualizar la fecha.");return w.json()}).then(async w=>{if(Swal.close(),F(),I(),w.resumenes_dias&&he(w.resumenes_dias),w.alerta_retraso){const S=w.alerta_retraso.es_elementos_con_fecha_propia||!1,C=S?"elementos":"planilla";Swal.fire({icon:"warning",title:"⚠️ Fecha de entrega adelantada",html:`
                                    <div class="text-left">
                                ...
                                `,showCancelButton:!0,confirmButtonText:"🚀 Adelantar fabricación",cancelButtonText:"Entendido",confirmButtonColor:"#10b981",cancelButtonColor:"#f59e0b"}).then(L=>{L.isConfirmed&&ut(w.alerta_retraso.elementos_ids||c.elementos_ids,g,S)})}if(w.opcion_posponer){const S=w.opcion_posponer.es_elementos_con_fecha_propia||!1,C=w.opcion_posponer.ordenes_afectadas||[],L=S?"Elementos con fecha propia":"Planilla";let T="";C.length>0&&(T=`
                                            ...
                                            <tbody>
                                                ${C.map(_=>`
                                                    <tr class="border-t">
                                                        ...
                                                        ${S?`<td class="px-2 py-1 text-center">${_.elementos_count||"-"}</td>`:""}
                                                    </tr>
                                                `).join("")}
                                            </tbody>
                                        </table>
        ...
        `}else{const a=O?O.toLocaleDateString("es-ES",{weekday:"short",day:"numeric",month:"short",year:"numeric"}):"";e.innerHTML=`
            <div class="flex items-center gap-2">
        ...
        `}clearTimeout(e._hideTimeout),e.style.display="block",e._hideTimeout=setTimeout(()=>{e.style.display="none"},4e3)}function kt(){if(document.getElementById("keyboard-nav-styles"))return;const e=document.createElement("style");e.id="keyboard-nav-styles",e.textContent=`
        /* Foco en días */
    ...
    `,document.head.appendChild(e)}Se(()=>{vt(),kt(),setTimeout(()=>{bt()},500)},{selector:'#calendario[data-calendar-type="salidas"]'});Ee(()=>{if(B&&(B(),B=null),window.calendar)try{window.calendar.destroy(),window.calendar=null}catch(a){console.warn("Error al limpiar calendario de salidas:",a)}const e=document.getElementById("keyboard-nav-indicator");e&&e.remove()});
