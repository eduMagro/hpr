    ...
    <div class="text-left">
      ...
      <div class="overflow-auto" style="max-height:50vh;border:1px solid #e5e7eb;border-radius:6px;">
        ...
        <thead class="sticky top-0 bg-white z-10">
          ...
          <tbody>${e.map((t,o)=>{var v,y,g;const s=((v=t.obra)==null?void 0:v.codigo)||"",r=((y=t.obra)==null?void 0:y.nombre)||"",l=t.seccion||"",u=t.descripcion||"",d=t.codigo||`Planilla ${t.id}`,n=t.peso_total?parseFloat(t.peso_total).toLocaleString("es-ES",{minimumFractionDigits:2,maximumFractionDigits:2})+" kg":"",i=me(t.fecha_estimada_entrega),c=t.elementos&&t.elementos.length>0,m=((g=t.elementos)==null?void 0:g.length)||0;let b="";return c&&(b=t.elementos.map((p,f)=>{const w=p.fecha_entrega||"",k=p.peso?parseFloat(p.peso).toFixed(2):"-";return`
