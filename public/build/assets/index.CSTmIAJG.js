let z=new Map,H=new Map;function xe(e,a){return`${e}|${a.startStr}|${a.endStr}`}function Se(e){return Date.now()-e.timestamp>6e4}function Ee(){if(z.size>8){const e=Array.from(z.entries()).sort((t,o)=>t[1].timestamp-o[1].timestamp);e.slice(0,e.length-8).forEach(([t])=>z.delete(t))}}async function ae(e,a){var r,d;const t=(d=(r=window.AppSalidas)==null?void 0:r.routes)==null?void 0:d.planificacion;if(!t)return{events:[],resources:[],totales:null};const o=xe(e,a),n=z.get(o);if(n&&!Se(n))return n.data;if(H.has(o))return H.get(o);const i=(async()=>{try{const l=new URLSearchParams({tipo:"all",viewType:e||"",start:a.startStr||"",end:a.endStr||""}),u=await fetch(`${t}?${l.toString()}`);if(!u.ok)throw new Error(`HTTP ${u.status}`);const p=await u.json(),h={events:p.events||[],resources:p.resources||[],totales:p.totales||null};return z.set(o,{data:h,timestamp:Date.now()}),Ee(),h}catch(l){return console.error("fetch all data falló:",l),{events:[],resources:[],totales:null}}finally{H.delete(o)}})();return H.set(o,i),i}function F(){z.clear(),H.clear()}function ke(e){var r,d;const a=((r=document.getElementById("solo-salidas"))==null?void 0:r.checked)||!1,t=((d=document.getElementById("solo-planillas"))==null?void 0:d.checked)||!1,o=e.filter(l=>{var u;return((u=l.extendedProps)==null?void 0:u.tipo)==="resumen-dia"}),n=e.filter(l=>{var u;return((u=l.extendedProps)==null?void 0:u.tipo)!=="resumen-dia"});let i=n;return a&&!t?i=n.filter(l=>{var u;return((u=l.extendedProps)==null?void 0:u.tipo)==="salida"}):t&&!a&&(i=n.filter(l=>{var p;const u=(p=l.extendedProps)==null?void 0:p.tipo;return u==="planilla"||u==="festivo"})),[...i,...o]}async function $e(e,a){const t=await ae(e,a);return ke(t.events)}async function Ce(e,a){return(await ae(e,a)).resources}async function qe(e,a){const t=await ae(e,a);if(!t.totales)return;const{semana:o,mes:n}=t.totales,i=b=>b!=null?Number(b).toLocaleString():"0",r=document.querySelector("#resumen-semanal-peso"),d=document.querySelector("#resumen-semanal-longitud"),l=document.querySelector("#resumen-semanal-diametro");r&&(r.textContent=`📦 ${i(o==null?void 0:o.peso)} kg`),d&&(d.textContent=`📏 ${i(o==null?void 0:o.longitud)} m`),l&&(l.textContent=o!=null&&o.diametro?`⌀ ${Number(o.diametro).toFixed(2)} mm`:"");const u=document.querySelector("#resumen-mensual-peso"),p=document.querySelector("#resumen-mensual-longitud"),h=document.querySelector("#resumen-mensual-diametro");if(u&&(u.textContent=`📦 ${i(n==null?void 0:n.peso)} kg`),p&&(p.textContent=`📏 ${i(n==null?void 0:n.longitud)} m`),h&&(h.textContent=n!=null&&n.diametro?`⌀ ${Number(n.diametro).toFixed(2)} mm`:""),a.startStr){const b=new Date(a.startStr),s={year:"numeric",month:"long"};let c=b.toLocaleDateString("es-ES",s);c=c.charAt(0).toUpperCase()+c.slice(1);const m=document.querySelector("#resumen-mensual-fecha");m&&(m.textContent=`(${c})`)}}function oe(e,a){const t=e.event.extendedProps||{};if(t.tipo!=="festivo"){if(t.tipo==="planilla"){const o=`
  ...
  `,document.head.appendChild(a)})();function Ae(e){const a=e.extendedProps||{};if(Array.isArray(a.planillas_ids)&&a.planillas_ids.length)return a.planillas_ids;const t=(e.id||"").match(/planilla-(\d+)/);return t?[Number(t[1])]:[]}async function De(e,a){var t,o;try{A()}catch{}if(!e)return Swal.fire("⚠️","ID de salida inválido.","warning");try{const n=await fetch(`${(o=(t=window.AppSalidas)==null?void 0:t.routes)==null?void 0:o.informacionPaquetesSalida}?salida_id=${e}`,{headers:{Accept:"application/json"}});if(!n.ok)throw new Error("Error al cargar información de la salida");const{salida:i,paquetesAsignados:r,paquetesDisponibles:d,paquetesTodos:l,filtros:u}=await n.json();Pe(i,r,d,l||[],u||{obras:[],planillas:[],obrasRelacionadas:[]},a)}catch(n){console.error(n),Swal.fire("❌","Error al cargar la información de la salida","error")}}function Pe(e,a,t,o,n,i){window._gestionPaquetesData={salida:e,paquetesAsignados:a,paquetesDisponibles:t,paquetesTodos:o,filtros:n,mostrarTodos:!1};const r=Ie(e,a,t,n);Swal.fire({title:`📦 Gestionar Paquetes - Salida ${e.codigo_salida||e.id}`,html:r,width:Math.min(window.innerWidth*.95,1200),showConfirmButton:!0,showCancelButton:!0,confirmButtonText:"💾 Guardar Cambios",cancelButtonText:"Cancelar",focusConfirm:!1,customClass:{popup:"w-full max-w-screen-xl"},didOpen:()=>{fe(),Me(),je(),setTimeout(()=>{ze()},100)},willClose:()=>{q.cleanup&&q.cleanup();const d=document.getElementById("modal-keyboard-indicator");d&&d.remove()},preConfirm:()=>He()}).then(async d=>{d.isConfirmed&&d.value&&await We(e.id,d.value,i)})}function Ie(e,a,t,o){var u,p;const n=a.reduce((h,b)=>h+(parseFloat(b.peso)||0),0);let i="";e.salida_clientes&&e.salida_clientes.length>0&&(i='<div class="col-span-2"><strong>Obras/Clientes:</strong><br>',e.salida_clientes.forEach(h=>{var m,g,v,k,y;const b=((m=h.obra)==null?void 0:m.obra)||"Obra desconocida",s=(g=h.obra)!=null&&g.cod_obra?`(${h.obra.cod_obra})`:"",c=((v=h.cliente)==null?void 0:v.empresa)||((y=(k=h.obra)==null?void 0:k.cliente)==null?void 0:y.empresa)||"";i+=`<span class="text-xs">• ${b} ${s}`,c&&(i+=` - ${c}`),i+="</span><br>"}),i+="</div>");const r=`
    ...
    `}function Q(e){return!e||e.length===0?'<div class="text-gray-400 text-sm text-center py-4 placeholder-sin-paquetes">Sin paquetes</div>':e.map(a=>{var t,o,n,i,r,d,l,u,p,h,b,s,c,m,g,v;return`
        <div
        ...
        >
            ...
            <div class="text-xs text-gray-500 mt-1">
                ...
                <div>👤 ${((g=(m=a.planilla)==null?void 0:m.cliente)==null?void 0:g.empresa)||"Sin cliente"}</div>
    ...
    <div class="text-left">
      ...
      <div class="overflow-auto" style="max-height:50vh;border:1px solid #e5e7eb;border-radius:6px;">
        ...
        <thead class="sticky top-0 bg-white z-10">
          ...
          <tbody>${e.map((t,o)=>{var s,c,m;const n=((s=t.obra)==null?void 0:s.codigo)||"",i=((c=t.obra)==null?void 0:c.nombre)||"",r=t.seccion||"";t.descripcion;const d=t.codigo||`Planilla ${t.id}`,l=t.peso_total?parseFloat(t.peso_total).toLocaleString("es-ES",{minimumFractionDigits:2,maximumFractionDigits:2})+" kg":"",u=Te(t.fecha_estimada_entrega),p=t.elementos&&t.elementos.length>0,h=((m=t.elementos)==null?void 0:m.length)||0;let b="";return p&&(b=t.elementos.map((g,v)=>{const k=g.fecha_entrega||"",y=g.peso?parseFloat(g.peso).toFixed(2):"-",E=g.codigo||"-",$=g.dimensiones&&g.dimensiones.trim()!=="",f=$?g.dimensiones.replace(/"/g,"&quot;").replace(/'/g,"&#39;"):"",w=E.replace(/"/g,"&quot;").replace(/'/g,"&#39;");return`
...
${b}`}).join("")}</tbody>
    ...
    `+Ke(o),{isConfirmed:r}=await Swal.fire({title:"",html:i,width:Math.min(window.innerWidth*.98,1200),customClass:{popup:"w-full max-w-screen-xl"},showCancelButton:!0,confirmButtonText:"💾 Guardar",cancelButtonText:"Cancelar",focusConfirm:!1,showClass:{popup:"swal-fade-in-zoom"},hideClass:{popup:"swal-fade-out"},didOpen:h=>{var m,g,v,k,y,E,$;et(h),W("#swal-drag",!1),setTimeout(()=>{const f=Swal.getHtmlContainer().querySelector('input[type="date"]');f==null||f.focus({preventScroll:!0})},120),Swal.getHtmlContainer().querySelectorAll('input[type="date"]').forEach(f=>{f.addEventListener("change",function(){ge(this.value)?this.classList.add("weekend-date"):this.classList.remove("weekend-date"),se(o)})});const s=Swal.getHtmlContainer();s.querySelectorAll(".planilla-row").forEach(f=>{f.addEventListener("click",w=>{if(w.target.closest("input, button"))return;const S=f.dataset.planillaId;if(!(f.dataset.tieneElementos==="true"))return;const L=s.querySelectorAll(`.elemento-planilla-${S}`),_=f.querySelector(".toggle-elementos"),T=(_==null?void 0:_.textContent)==="▼";L.forEach(P=>{P.classList.toggle("hidden",T)}),_&&(_.textContent=T?"▶":"▼")})}),s.querySelectorAll(".elemento-row").forEach(f=>{f.addEventListener("click",w=>{if(w.target.closest("input, button, .ver-figura-elemento"))return;const S=f.querySelector(".elemento-checkbox");S&&(S.checked=!S.checked,c())})}),(m=s.querySelector("#expandir-todos"))==null||m.addEventListener("click",()=>{s.querySelectorAll(".elemento-row").forEach(f=>f.classList.remove("hidden")),s.querySelectorAll(".toggle-elementos").forEach(f=>f.textContent="▼")}),(g=s.querySelector("#colapsar-todos"))==null||g.addEventListener("click",()=>{s.querySelectorAll(".elemento-row").forEach(f=>f.classList.add("hidden")),s.querySelectorAll(".toggle-elementos").forEach(f=>f.textContent="▶")});function c(){const w=s.querySelectorAll(".elemento-checkbox:checked").length,S=s.querySelector("#barra-acciones-masivas"),C=s.querySelector("#contador-seleccionados");w>0?(S==null||S.classList.remove("hidden"),C&&(C.textContent=w)):S==null||S.classList.add("hidden")}s.querySelectorAll(".elemento-checkbox").forEach(f=>{f.addEventListener("change",c)}),(v=s.querySelector("#seleccionar-todos-elementos"))==null||v.addEventListener("click",()=>{s.querySelectorAll(".elemento-row").forEach(f=>f.classList.remove("hidden")),s.querySelectorAll(".toggle-elementos").forEach(f=>f.textContent="▼"),s.querySelectorAll(".elemento-checkbox").forEach(f=>{f.checked=!0}),c()}),(k=s.querySelector("#seleccionar-sin-fecha"))==null||k.addEventListener("click",()=>{s.querySelectorAll(".elemento-row").forEach(f=>f.classList.remove("hidden")),s.querySelectorAll(".toggle-elementos").forEach(f=>f.textContent="▼"),s.querySelectorAll(".elemento-checkbox").forEach(f=>{f.checked=!1}),s.querySelectorAll(".elemento-checkbox").forEach(f=>{const w=f.dataset.elementoId,S=s.querySelector(`.elemento-fecha[data-elemento-id="${w}"]`);S&&!S.value&&(f.checked=!0)}),c()}),(y=s.querySelector("#deseleccionar-todos"))==null||y.addEventListener("click",()=>{s.querySelectorAll(".elemento-checkbox").forEach(f=>{f.checked=!1}),c()}),(E=s.querySelector("#aplicar-fecha-masiva"))==null||E.addEventListener("click",()=>{var L;const f=(L=s.querySelector("#fecha-masiva"))==null?void 0:L.value;if(!f){alert("Por favor, selecciona una fecha para aplicar");return}s.querySelectorAll(".elemento-checkbox:checked").forEach(_=>{const T=_.dataset.elementoId,P=s.querySelector(`.elemento-fecha[data-elemento-id="${T}"]`);P&&(P.value=f,P.dispatchEvent(new Event("change")))});const S=s.querySelector("#aplicar-fecha-masiva"),C=S.textContent;S.textContent="✓ Aplicado",S.classList.add("bg-green-600"),setTimeout(()=>{S.textContent=C,S.classList.remove("bg-green-600")},1500)}),($=s.querySelector("#limpiar-fecha-seleccionados"))==null||$.addEventListener("click",()=>{s.querySelectorAll(".elemento-checkbox:checked").forEach(w=>{const S=w.dataset.elementoId,C=s.querySelector(`.elemento-fecha[data-elemento-id="${S}"]`);C&&(C.value="",C.dispatchEvent(new Event("change")))})}),s.querySelectorAll(".aplicar-fecha-elementos").forEach(f=>{f.addEventListener("click",w=>{var L;w.stopPropagation();const S=f.dataset.planillaId,C=(L=s.querySelector(`.planilla-fecha[data-planilla-id="${S}"]`))==null?void 0:L.value;C&&s.querySelectorAll(`.elemento-fecha[data-planilla-id="${S}"]`).forEach(_=>{_.value=C,_.dispatchEvent(new Event("change"))})})}),s.querySelectorAll(".ver-figura-elemento").forEach(f=>{f.addEventListener("mouseenter",w=>{var _,T;const S=f.dataset.elementoId,C=((_=f.dataset.elementoCodigo)==null?void 0:_.replace(/&quot;/g,'"').replace(/&#39;/g,"'"))||"",L=((T=f.dataset.dimensiones)==null?void 0:T.replace(/&quot;/g,'"').replace(/&#39;/g,"'"))||"";typeof window.dibujarFiguraElemento=="function"&&Ye(S,C,L,f)}),f.addEventListener("mouseleave",w=>{setTimeout(()=>{const S=document.getElementById("modal-figura-elemento-overlay");S&&!S.matches(":hover")&&S.remove()},100)}),f.addEventListener("click",w=>{w.stopPropagation()})}),setTimeout(()=>{se(o)},100)}});if(!r)return;const d=Swal.getHtmlContainer(),l=d.querySelectorAll(".planilla-fecha"),u=Array.from(l).map(h=>{const b=Number(h.getAttribute("data-planilla-id")),s=d.querySelectorAll(`.elemento-fecha[data-planilla-id="${b}"]`),c=Array.from(s).map(m=>({id:Number(m.getAttribute("data-elemento-id")),fecha_entrega:m.value||null}));return{id:b,fecha_estimada_entrega:h.value,elementos:c.length>0?c:void 0}}),p=await Ze(u);await Swal.fire({title:p.success?"Guardado":"Atención",text:p.message||(p.success?"Fechas actualizadas":"No se pudieron actualizar"),icon:p.success?"success":"warning",timer:p.success?1500:void 0,showConfirmButton:!p.success}),p.success&&a&&Ue(a,p)}catch(t){console.error("[CambiarFechasEntrega] error:",t),Swal.fire("❌",(t==null?void 0:t.message)||"Ocurrió un error al actualizar las fechas.","error")}}function ie(e,a){e.el.addEventListener("mousedown",A),e.el.addEventListener("contextmenu",t=>{t.preventDefault(),t.stopPropagation();const o=e.event,n=o.extendedProps||{},i=n.tipo||"planilla";let r="";if(i==="salida"){if(n.clientes&&Array.isArray(n.clientes)&&n.clientes.length>0){const u=n.clientes.map(p=>p.nombre).filter(Boolean).join(", ");u&&(r+=`<br><span style="font-weight:400;color:#4b5563;font-size:11px">👤 ${u}</span>`)}n.obras&&Array.isArray(n.obras)&&n.obras.length>0&&(r+='<br><span style="font-weight:400;color:#4b5563;font-size:11px">🏗️ ',r+=n.obras.map(u=>{const p=u.codigo?`(${u.codigo})`:"";return`${u.nombre} ${p}`}).join(", "),r+="</span>")}const d=`
...
`)[0])||"",u=o.cliente||"",p=o.pesoTotal?Number(o.pesoTotal).toLocaleString("es-ES",{maximumFractionDigits:0}):"",h=o.longitudTotal?Number(o.longitudTotal).toLocaleString("es-ES",{maximumFractionDigits:0}):"",b=o.diametroMedio?Number(o.diametroMedio).toFixed(1):"",s=((m=a==null?void 0:a.style)==null?void 0:m.backgroundColor)||e.backgroundColor||"#6366f1";return t.innerHTML=`
    ...
    `,document.body.appendChild(t),t}function re(e,a,t,o){const n=document.getElementById("custom-drag-ghost");if(n){if(n.style.left=`${e+20}px`,n.style.top=`${a-20}px`,t){const i=n.querySelector(".ghost-dest-time");i&&(i.textContent=t)}if(o){const i=n.querySelector(".ghost-dest-date");if(i){const r=new Date(o+"T00:00:00"),d={weekday:"short",day:"numeric",month:"short"};i.textContent=r.toLocaleDateString("es-ES",d)}}}}function ee(){const e=document.getElementById("custom-drag-ghost");e&&e.remove()}function le(e,a){const t=a==null?void 0:a.querySelector(".fc-timegrid-slots");if(!t)return null;const o=t.getBoundingClientRect(),n=e-o.top+t.scrollTop,i=t.scrollHeight||o.height,r=5,d=20,l=d-r,u=n/i*l,p=r*60+u*60,h=Math.round(p/30)*30,b=Math.max(r,Math.min(d-1,Math.floor(h/60))),s=h%60;return`${String(b).padStart(2,"0")}:${String(s).padStart(2,"0")}`}function de(e){const a=document.querySelectorAll(".fc-timegrid-slot, .fc-timegrid-col");e?a.forEach(t=>{t.classList.add("fc-drop-zone-highlight")}):a.forEach(t=>{t.classList.remove("fc-drop-zone-highlight")})}function st(){if(!window.FullCalendar)return console.error("FullCalendar (global) no está cargado. Asegúrate de tener los <script> CDN en el Blade."),null;if(!document.getElementById("fc-mirror-hide-style-global")){const u=document.createElement("style");u.id="fc-mirror-hide-style-global",u.textContent=`
        ...
        `,document.head.appendChild(u)}x&&x.destroy();const e=["resourceTimeGridDay","resourceTimelineWeek","dayGridMonth"];let a=localStorage.getItem("ultimaVistaCalendario");e.includes(a)||(a="resourceTimeGridDay");const t=localStorage.getItem("fechaCalendario");let o=null;const n=document.getElementById("calendario");if(!n)return console.error("#calendario no encontrado"),null;function i(u){return x?x.getEvents().some(p=>{var s,c;const h=(p.startStr||((s=p.start)==null?void 0:s.toISOString())||"").split("T")[0];return(((c=p.extendedProps)==null?void 0:c.tipo)==="festivo"||typeof p.id=="string"&&p.id.startsWith("festivo-"))&&h===u}):!1}at(n,()=>{x=new FullCalendar.Calendar(n,{schedulerLicenseKey:"CC-Attribution-NonCommercial-NoDerivatives",locale:"es",navLinks:!0,navLinkDayClick:(s,c)=>{var k;const m=s.getDay(),g=m===0||m===6,v=(k=x==null?void 0:x.view)==null?void 0:k.type;if(g&&(v==="resourceTimelineWeek"||v==="dayGridMonth")){c.preventDefault();let y;v==="dayGridMonth"?y=m===6?"saturday":"sunday":y=s.toISOString().split("T")[0],window.expandedWeekendDays||(window.expandedWeekendDays=new Set),window.expandedWeekendDays.has(y)?window.expandedWeekendDays.delete(y):window.expandedWeekendDays.add(y),localStorage.setItem("expandedWeekendDays",JSON.stringify([...window.expandedWeekendDays])),x.render(),setTimeout(()=>{var E;return(E=window.applyWeekendCollapse)==null?void 0:E.call(window)},50);return}x.changeView("resourceTimeGridDay",s)},initialView:a,initialDate:t?new Date(t):void 0,dayMaxEventRows:!1,dayMaxEvents:!1,slotMinTime:"05:00:00",slotMaxTime:"20:00:00",buttonText:{today:"Hoy",resourceTimeGridDay:"Día",resourceTimelineWeek:"Semana",dayGridMonth:"Mes"},progressiveEventRendering:!0,expandRows:!0,height:"auto",events:(s,c,m)=>{var v;const g=s.view&&s.view.type||((v=x==null?void 0:x.view)==null?void 0:v.type)||"resourceTimeGridDay";$e(g,s).then(c).catch(m)},resources:(s,c,m)=>{var v;const g=s.view&&s.view.type||((v=x==null?void 0:x.view)==null?void 0:v.type)||"resourceTimeGridDay";Ce(g,s).then(c).catch(m)},headerToolbar:{left:"prev,next today",center:"title",right:"resourceTimeGridDay,resourceTimelineWeek,dayGridMonth"},eventOrderStrict:!0,eventOrder:(s,c)=>{var y,E;const m=((y=s.extendedProps)==null?void 0:y.tipo)==="resumen-dia",g=((E=c.extendedProps)==null?void 0:E.tipo)==="resumen-dia";if(m&&!g)return-1;if(!m&&g)return 1;const v=parseInt(String(s.extendedProps.cod_obra??"").replace(/\D/g,""),10)||0,k=parseInt(String(c.extendedProps.cod_obra??"").replace(/\D/g,""),10)||0;return v-k},datesSet:s=>{try{const c=it(s);localStorage.setItem("fechaCalendario",c),localStorage.setItem("ultimaVistaCalendario",s.view.type),d(),clearTimeout(o),o=setTimeout(async()=>{F(),x.refetchResources(),x.refetchEvents(),await qe(s.view.type,{startStr:s.startStr,endStr:s.endStr}),I(),(s.view.type==="resourceTimelineWeek"||s.view.type==="dayGridMonth")&&window.applyWeekendCollapse&&setTimeout(()=>window.applyWeekendCollapse(),150)},0)}catch(c){console.error("Error en datesSet:",c)}},loading:s=>{const c=document.getElementById("calendario-loading"),m=document.getElementById("loading-text");if(c&&(s?(c.classList.remove("hidden"),m&&(m.textContent="Cargando eventos...")):c.classList.add("hidden")),!s&&x){const g=x.view.type;g==="resourceTimeGridDay"&&setTimeout(()=>l(),150),(g==="resourceTimelineWeek"||g==="dayGridMonth")&&window.applyWeekendCollapse&&setTimeout(()=>window.applyWeekendCollapse(),150)}},viewDidMount:s=>{d(),s.view.type==="resourceTimeGridDay"&&setTimeout(()=>l(),100),s.view.type==="dayGridMonth"&&setTimeout(()=>{document.querySelectorAll(".fc-daygrid-event-harness").forEach(c=>{c.querySelector(".evento-resumen-diario")||(c.style.setProperty("width","100%","important"),c.style.setProperty("max-width","100%","important"),c.style.setProperty("position","static","important"),c.style.setProperty("left","unset","important"),c.style.setProperty("right","unset","important"),c.style.setProperty("top","unset","important"),c.style.setProperty("inset","unset","important"),c.style.setProperty("margin","0 0 2px 0","important"))}),document.querySelectorAll(".fc-daygrid-event:not(.evento-resumen-diario)").forEach(c=>{c.style.setProperty("width","100%","important"),c.style.setProperty("max-width","100%","important"),c.style.setProperty("margin","0","important"),c.style.setProperty("position","static","important"),c.style.setProperty("left","unset","important"),c.style.setProperty("right","unset","important"),c.style.setProperty("inset","unset","important")})},50)},eventContent:s=>{var k;const c=s.event.backgroundColor||"#9CA3AF",m=s.event.extendedProps||{},g=(k=x==null?void 0:x.view)==null?void 0:k.type;if(m.tipo==="resumen-dia"){const y=Number(m.pesoTotal||0).toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:0}),E=Number(m.longitudTotal||0).toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:0}),$=m.diametroMedio?Number(m.diametroMedio).toFixed(1):null;if(g==="resourceTimelineWeek")return{html:`
    ...
    `;if(m.tipo==="planilla"){const y=m.pesoTotal!=null?`📦 ${Number(m.pesoTotal).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2})} kg`:null,E=m.longitudTotal!=null?`📏 ${Number(m.longitudTotal).toLocaleString()} m`:null,$=m.diametroMedio!=null?`⌀ ${Number(m.diametroMedio).toFixed(2)} mm`:null,f=[y,E,$].filter(Boolean);f.length>0&&(v+=`<div class="text-sm text-black font-semibold">${f.join(" | ")}</div>`),m.tieneSalidas&&Array.isArray(m.salidas_codigos)&&m.salidas_codigos.length>0&&(v+=`
            <div class="mt-2">
                <span class="text-black bg-yellow-400 rounded px-2 py-1 inline-block text-xs font-semibold">
                    Salidas: ${m.salidas_codigos.join(", ")}
                </span>
            </div>`)}return v+="</div>",{html:v}},eventDidMount:function(s){var E,$,f,w,S;const c=s.event.extendedProps||{};if(s.el.setAttribute("draggable","false"),s.el.ondragstart=C=>(C.preventDefault(),!1),c.tipo==="resumen-dia"){s.el.classList.add("evento-resumen-diario"),s.el.style.cursor="default";return}if(s.view.type==="dayGridMonth"){const C=s.el.closest(".fc-daygrid-event-harness");C&&C.classList.add("evento-fullwidth"),s.el.classList.add("evento-fullwidth-event")}const m=(((E=document.getElementById("filtro-obra"))==null?void 0:E.value)||"").trim().toLowerCase(),g=((($=document.getElementById("filtro-nombre-obra"))==null?void 0:$.value)||"").trim().toLowerCase(),v=(((f=document.getElementById("filtro-cod-cliente"))==null?void 0:f.value)||"").trim().toLowerCase(),k=(((w=document.getElementById("filtro-cliente"))==null?void 0:w.value)||"").trim().toLowerCase(),y=(((S=document.getElementById("filtro-cod-planilla"))==null?void 0:S.value)||"").trim().toLowerCase();if(m||g||v||k||y){let C=!1;if(c.tipo==="salida"&&c.obras&&Array.isArray(c.obras)){if(C=c.obras.some(L=>{const _=(L.codigo||"").toString().toLowerCase(),T=(L.nombre||"").toString().toLowerCase(),P=(L.cod_cliente||"").toString().toLowerCase(),X=(L.cliente||"").toString().toLowerCase(),Y=!m||_.includes(m),K=!g||T.includes(g),J=!v||P.includes(v),R=!k||X.includes(k);return Y&&K&&J&&R}),y&&c.planillas_codigos&&Array.isArray(c.planillas_codigos)){const L=c.planillas_codigos.some(_=>(_||"").toString().toLowerCase().includes(y));C=C&&L}}else{const L=(c.cod_obra||"").toString().toLowerCase(),_=(c.nombre_obra||s.event.title||"").toString().toLowerCase(),T=(c.cod_cliente||"").toString().toLowerCase(),P=(c.cliente||"").toString().toLowerCase(),X=!m||L.includes(m),Y=!g||_.includes(g),K=!v||T.includes(v),J=!k||P.includes(k);let R=!0;y&&(c.planillas_codigos&&Array.isArray(c.planillas_codigos)?R=c.planillas_codigos.some(we=>(we||"").toString().toLowerCase().includes(y)):R=(s.event.title||"").toLowerCase().includes(y)),C=X&&Y&&K&&J&&R}C?(s.el.classList.add("evento-filtrado"),s.el.classList.remove("evento-atenuado")):(s.el.classList.add("evento-atenuado"),s.el.classList.remove("evento-filtrado"))}else s.el.classList.remove("evento-filtrado"),s.el.classList.remove("evento-atenuado");typeof oe=="function"&&oe(s),typeof ie=="function"&&ie(s,x)},eventAllow:(s,c)=>{var g;const m=(g=c.extendedProps)==null?void 0:g.tipo;return!(m==="resumen-dia"||m==="festivo")},snapDuration:"00:30:00",eventDragStart:s=>{var $;window._isDragging=!0,window._draggedEvent=s.event,nt(s.event,s.el),document.body.classList.add("fc-dragging-active");const c=ot(),m=f=>{f.dataTransfer&&window._isDragging&&f.dataTransfer.setDragImage(c,0,0)};document.addEventListener("dragstart",m,!0),window._nativeDragStartHandler=m;const g=document.getElementById("calendario");(($=x==null?void 0:x.view)==null?void 0:$.type)==="resourceTimeGridDay"&&de(!0);const v=(f,w)=>{const S=document.elementsFromPoint(f,w);for(const C of S){const L=C.closest(".fc-daygrid-day");if(L)return L.getAttribute("data-date");const _=C.closest("[data-date]");if(_)return _.getAttribute("data-date")}return null};let k=!1;const y=f=>{!window._isDragging||k||(k=!0,requestAnimationFrame(()=>{if(k=!1,!window._isDragging)return;const w=le(f.clientY,g),S=v(f.clientX,f.clientY);re(f.clientX,f.clientY,w,S)}))};if(document.addEventListener("mousemove",y,{passive:!0}),window._dragMouseMoveHandler=y,s.jsEvent){const f=le(s.jsEvent.clientY,g),w=v(s.jsEvent.clientX,s.jsEvent.clientY);re(s.jsEvent.clientX,s.jsEvent.clientY,f,w)}window._dragOriginalStart=s.event.start,window._dragOriginalEnd=s.event.end,window._dragEventId=s.event.id;const E=f=>{if(window._isDragging){f.preventDefault(),f.stopPropagation(),f.stopImmediatePropagation(),window._cancelDrag=!0,ee();const w=new PointerEvent("pointerup",{bubbles:!0,cancelable:!0,clientX:f.clientX,clientY:f.clientY});document.dispatchEvent(w)}};document.addEventListener("contextmenu",E,{capture:!0}),window._dragContextMenuHandler=E},eventDragStop:s=>{window._isDragging=!1,window._draggedEvent=null,window._nativeDragStartHandler&&(document.removeEventListener("dragstart",window._nativeDragStartHandler,!0),window._nativeDragStartHandler=null),window._dragMouseMoveHandler&&(document.removeEventListener("mousemove",window._dragMouseMoveHandler),window._dragMouseMoveHandler=null),window._dragContextMenuHandler&&(document.removeEventListener("contextmenu",window._dragContextMenuHandler,{capture:!0}),window._dragContextMenuHandler=null),window._dragOriginalStart=null,window._dragOriginalEnd=null,window._dragEventId=null,ee(),document.body.classList.remove("fc-dragging-active"),de(!1)},eventDrop:s=>{var y,E,$,f;if(window._cancelDrag){window._cancelDrag=!1,s.revert(),window._dragOriginalStart&&(s.event.setStart(window._dragOriginalStart),window._dragOriginalEnd&&s.event.setEnd(window._dragOriginalEnd));return}const c=s.event.extendedProps||{},m=s.event.id,g=(y=s.event.start)==null?void 0:y.toISOString(),v={fecha:g,tipo:c.tipo,planillas_ids:c.planillas_ids||[],elementos_ids:c.elementos_ids||[],verificar_fabricacion:!0},k=((($=(E=window.AppSalidas)==null?void 0:E.routes)==null?void 0:$.updateItem)||"").replace("__ID__",m);Swal.fire({title:"Actualizando fecha...",allowOutsideClick:!1,allowEscapeKey:!1,showConfirmButton:!1,didOpen:()=>{Swal.showLoading()}}),fetch(k,{method:"PUT",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":(f=window.AppSalidas)==null?void 0:f.csrf},body:JSON.stringify(v)}).then(w=>{if(!w.ok)throw new Error("No se pudo actualizar la fecha.");return w.json()}).then(async w=>{if(Swal.close(),F(),I(),w.resumenes_dias&&ye(w.resumenes_dias),w.alerta_retraso){const S=w.alerta_retraso.es_elementos_con_fecha_propia||!1,C=S?"elementos":"planilla";Swal.fire({icon:"warning",title:"⚠️ Fecha de entrega adelantada",html:`
                                    <div class="text-left">
                    ...
                    </div>`}),windowResize:()=>I()}),x.render(),I(),tt(x),setTimeout(()=>{const s=document.getElementById("calendario-loading");s&&!s.classList.contains("opacity-0")&&(s.classList.add("opacity-0","pointer-events-none"),s.classList.remove("opacity-100"))},500);const u=localStorage.getItem("expandedWeekendDays");window.expandedWeekendDays=new Set(u?JSON.parse(u):[]),window.weekendDefaultCollapsed=!0;function p(s){const m=new Date(s+"T00:00:00").getDay();return m===0||m===6}function h(){var c,m,g;const s=(c=x==null?void 0:x.view)==null?void 0:c.type;if(s==="resourceTimelineWeek"&&(document.querySelectorAll(".fc-timeline-slot[data-date]").forEach(y=>{var $;const E=y.getAttribute("data-date");p(E)&&((($=window.expandedWeekendDays)==null?void 0:$.has(E))?y.classList.remove("weekend-collapsed"):y.classList.add("weekend-collapsed"))}),document.querySelectorAll(".fc-timeline-lane td[data-date]").forEach(y=>{var $;const E=y.getAttribute("data-date");p(E)&&((($=window.expandedWeekendDays)==null?void 0:$.has(E))?y.classList.remove("weekend-collapsed"):y.classList.add("weekend-collapsed"))})),s==="dayGridMonth"){const v=(m=window.expandedWeekendDays)==null?void 0:m.has("saturday"),k=(g=window.expandedWeekendDays)==null?void 0:g.has("sunday"),y=document.querySelectorAll(".fc-col-header-cell.fc-day-sat"),E=document.querySelectorAll(".fc-col-header-cell.fc-day-sun");y.forEach(f=>{v?f.classList.remove("weekend-day-collapsed"):f.classList.add("weekend-day-collapsed")}),E.forEach(f=>{k?f.classList.remove("weekend-day-collapsed"):f.classList.add("weekend-day-collapsed")}),document.querySelectorAll(".fc-daygrid-day.fc-day-sat").forEach(f=>{v?f.classList.remove("weekend-day-collapsed"):f.classList.add("weekend-day-collapsed")}),document.querySelectorAll(".fc-daygrid-day.fc-day-sun").forEach(f=>{k?f.classList.remove("weekend-day-collapsed"):f.classList.add("weekend-day-collapsed")});const $=document.querySelector(".fc-dayGridMonth-view table");if($){let f=$.querySelector("colgroup");if(!f){f=document.createElement("colgroup");for(let S=0;S<7;S++)f.appendChild(document.createElement("col"));$.insertBefore(f,$.firstChild)}const w=f.querySelectorAll("col");w.length>=7&&(w[5].style.width=v?"":"40px",w[6].style.width=k?"":"40px")}}}function b(s){window.expandedWeekendDays||(window.expandedWeekendDays=new Set),window.expandedWeekendDays.has(s)?window.expandedWeekendDays.delete(s):window.expandedWeekendDays.add(s),localStorage.setItem("expandedWeekendDays",JSON.stringify([...window.expandedWeekendDays])),h()}n.addEventListener("click",s=>{var g;const c=s.target.closest(".weekend-header");if(c){const v=c.getAttribute("data-date");if(v){s.preventDefault(),s.stopPropagation(),b(v);return}}if(((g=x==null?void 0:x.view)==null?void 0:g.type)==="dayGridMonth"){const v=s.target.closest(".fc-col-header-cell.fc-day-sat, .fc-col-header-cell.fc-day-sun");if(v){s.preventDefault(),s.stopPropagation();const E=v.classList.contains("fc-day-sat")?"saturday":"sunday";b(E);return}const k=s.target.closest(".fc-daygrid-day.fc-day-sat, .fc-daygrid-day.fc-day-sun");if(k&&!s.target.closest(".fc-event")){s.preventDefault(),s.stopPropagation();const E=k.classList.contains("fc-day-sat")?"saturday":"sunday";b(E);return}}},!0),setTimeout(()=>h(),100),window.applyWeekendCollapse=h,n.addEventListener("contextmenu",s=>{if(window._isDragging||window._cancelDrag)return;const c=s.target.closest(".fc-daygrid-day, .fc-timeline-slot, .fc-timegrid-slot, .fc-col-header-cell");if(c){let m=c.getAttribute("data-date");if(!m){const g=s.target.closest("[data-date]");g&&(m=g.getAttribute("data-date"))}if(m&&x){const g=x.view.type;(g==="resourceTimelineWeek"||g==="dayGridMonth")&&(s.preventDefault(),s.stopPropagation(),Swal.fire({title:"📅 Ir a día",text:`¿Quieres ver el día ${m}?`,icon:"question",showCancelButton:!0,confirmButtonText:"Sí, ir al día",cancelButtonText:"Cancelar"}).then(v=>{v.isConfirmed&&(x.changeView("resourceTimeGridDay",m),I())}))}}})}),window.addEventListener("shown.bs.tab",I),window.addEventListener("shown.bs.collapse",I),window.addEventListener("shown.bs.modal",I);function d(){document.querySelectorAll(".resumen-diario-custom").forEach(p=>p.remove())}function l(){if(!x||x.view.type!=="resourceTimeGridDay"){d();return}d();const u=x.getDate(),p=u.getFullYear(),h=String(u.getMonth()+1).padStart(2,"0"),b=String(u.getDate()).padStart(2,"0"),s=`${p}-${h}-${b}`,c=x.getEvents().find(m=>{var g,v;return((g=m.extendedProps)==null?void 0:g.tipo)==="resumen-dia"&&((v=m.extendedProps)==null?void 0:v.fecha)===s});if(c&&c.extendedProps){const m=Number(c.extendedProps.pesoTotal||0).toLocaleString(),g=Number(c.extendedProps.longitudTotal||0).toLocaleString(),v=c.extendedProps.diametroMedio?Number(c.extendedProps.diametroMedio).toFixed(2):null,k=document.createElement("div");k.className="resumen-diario-custom",k.innerHTML=`
                <div class="bg-yellow-100 border-2 border-yellow-400 rounded-lg px-6 py-4 mb-4 shadow-sm">
                    <div class="flex items-center justify-center gap-8 text-base font-semibold">
                        <div class="text-yellow-900">📦 Peso: ${m} kg</div>
